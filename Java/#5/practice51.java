...
class KAKUCHOUCircleFrameD extends JFrame implements ActionListener {
    private CirclePanel panel;
    private JButton b1,b2,b3,b4,b5;
    private JPanel p1 = new JPanel(),p2 = new JPanel();
    public KAKUCHOUCircleFrameD(){
	...
	else if(ev.getSource() == b3)panel.setPanelColor(Color.RED);
	else if(ev.getSource() == b4)panel.setRadius(5);
	else if(ev.getSource() == b5)panel.setRadius(10);
    }
    
    public static void main(String argv[]) {
	new KAKUCHOUCircleFrameD();  
    }
}
